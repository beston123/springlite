...
public abstract class BeanUtils {
	 ...
	 * @throws BeansException if the bean cannot be instantiated
	 */
	...
	public static <T> T instantiateClass(Class<?> clazz, Class<T> assignableTo) throws BeansException {
		//Validate.isAssignable(assignableTo, clazz);
...
//	}
	...
	public static boolean isSimpleType(String type){
		...
		if(type.startsWith("java.") || type.startsWith("javax.")){
			try {
				...
				logger.debug("Can not found class '"+ type +"'.");
				return false;
			}
		}
		return false;
	...
	public static Object convertByType(Object value, Class<?> clazz){
		String type = clazz.getName();
		if(!isSimpleProperty(clazz)) {
			throw new BeanCreationException("Can not cast value '"+ value +
					" from class '" + value.getClass().getName() +"' to not simple type '" + clazz.getName()+"'.");
		}
		try {
			if("string".equals(type.toLowerCase()) || String.class.getName().equals(type)){
				...
				throw new BeanCreationException("Can not cast value '"+ value +
						" from class '" + value.getClass().getName() +"' to unknown type '" + clazz.getName()+"'.");
			}
		} catch (NumberFormatException e) {
			throw new BeanCreationException("Can not cast value '"+ value + "' to Number '" + clazz.getName()+"'.", e);
		} catch (ClassCastException e){
			throw new BeanCreationException("Can not cast value '"+ value +
					" from class '" + value.getClass().getName() +"' to class '" + clazz.getName()+"'.", e);
		} catch (MalformedURLException e) {
			throw new BeanCreationException("Can not cast value '"+ value + "' to URL '" + clazz.getName()+"'.", e);
		}
	}
