...
public class DisposableBeanAdapter implements DisposableBean, Runnable, Serializable {
    ...
    public DisposableBeanAdapter(Object bean, String beanName, RootBeanDefinition beanDefinition,
        ...
        Validate.notNull(bean, "Disposable bean must not be null");
        this.bean = bean;
...
//                }
                ...
                if (paramTypes.length > 1) {
                    throw new BeansException("Method '" + destroyMethodName + "' of bean '" +
        ...
        this.beanPostProcessors = filterBeanPostProcessors(postProcessors);
    }
    ...
    private List<DestructionAwareBeanPostProcessor> filterBeanPostProcessors(List<BeanPostProcessor> postProcessors){
        List<DestructionAwareBeanPostProcessor> filteredPostProcessors = null;
        if(CollectionUtils.isNotEmpty(postProcessors)){
            filteredPostProcessors = new ArrayList<DestructionAwareBeanPostProcessor>();
    ...
    private Method determineDestroyMethod() {
        try {
            ...
            throw new BeansException("Couldn't find a unique destroy method on bean with name '" +
